...
6. 편집 상태는 sessionStorage에 자동 보존됩니다.
...
- 편집 상태는 `light-knitting-chart:latest` 키로 sessionStorage에 자동 저장됩니다.
...
(색 사용)
- `src/stores/useColorHistory.ts`
  - 기호/배색 브러시에서 사용한 컬러 HEX 코드 히스토리를 관리합니다.
...
- 캔버스에 그릴 때 sessionStorage의 편집 상태만 갱신되어야 합니다.
